...
const footer=await fragment('footer',{name:e(site.name)});
...
await output('sitemap.xml',`<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">${paths.map(p=>`<url><loc>${site.domain}${p}</loc></url>`).join('')}</urlset>`);
